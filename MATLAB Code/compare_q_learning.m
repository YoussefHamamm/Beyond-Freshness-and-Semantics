...
% ========== GLOBAL PARAMETERS =============================================
K      = 20;                % horizon (max expiration time)
r      = 1.0;               % reward for having fresh packet at receiver
c0     = 0.5;               % cost used for demo / policy comparison
ps0    = 0.5;               % success probability for demo

% IMPROVED: Increased iterations for better convergence
STEPS  = 2e4;               % RL iterations (increased from 5e5)
